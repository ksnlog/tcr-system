...
public final class KoinExtKt$androidContext$1 extends Lambda implements Function1<Module, Unit> {
    ...
    /* loaded from: /home/mailboxkishan/dex_files/classes.dex */
    public static final class AnonymousClass1 extends Lambda implements Function2<Scope, ParametersHolder, Application> {

        /* renamed from: d  reason: collision with root package name */
        final /* synthetic */ Context f2514d;
        ...
        public final Application invoke(Scope single, ParametersHolder it) {
            ...
            Intrinsics.f(it, "it");
            return (Application) this.f2514d;
        }
    }
    ...
    public final void a(Module module) {
        ...
        AnonymousClass1 anonymousClass1 = new AnonymousClass1(this.f2513d);
        StringQualifier a2 = ScopeRegistry.f2580e.a();
        Kind kind = Kind.Singleton;
        f2 = CollectionsKt__CollectionsKt.f();
        SingleInstanceFactory<?> singleInstanceFactory = new SingleInstanceFactory<>(new BeanDefinition(a2, Reflection.b(Application.class), null, anonymousClass1, kind, f2));
